...
public class LoaderController implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        loadData("DOP_ZachParkoviste_b_mercator-buffer20.shp", "DOP_ZachParkoviste_b-buffer20");
        loadData("DOP_ZPS_Automaty_b_mercator.shp", "DOP_ZPS_Automaty_b_mercator");
        loadData("DOP_ZPS_Automaty_b_mercator-buffer20.shp", "DOP_ZPS_Automaty_b-buffer20");
    }
